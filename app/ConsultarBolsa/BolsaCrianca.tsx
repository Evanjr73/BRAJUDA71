...
export default function BolsaCrianca() {
        ...
        <ImageBackground source={require("../../assets/images/25.jpg")} resizeMode="cover" style={styles.image}>
            ...
            <View style={{ height: "65%", width: "100%", backgroundColor: "green", marginBottom: 15 }}>
                <View style={styles.container}>
                    <View style={styles.card}>
                        ...
                        <Text>
                            Agora informe quantoas crianças de 6 meses até 6 anos fazem parte do núcleo familiar
                        </Text>
                        <TextInput
                            style={styles.input}
            ...
            <View style={style.container}>
                <Pressable style={style.button} >
                    ...
                    <Link href={"/ConsultarBolsa/BolsaAdolescente"}>
